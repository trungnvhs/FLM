                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        <div class="heading-bx left">
                            ...
                            <p style="color: #000000"><i class="fa fa-envelope-o" style="font-size:45px;color:#ffcc00"></i> Forgot Password with Email<a href="forgotPassword.jsp" > Click here</a><p>

                        </div>	
                        <form id="registerForm" class="contact-bx" action="forgotPhoneController" method="POST" >
