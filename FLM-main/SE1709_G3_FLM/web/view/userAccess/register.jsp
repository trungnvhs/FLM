                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        <div class="heading-bx left">
                            <h2 class="title-head">Register Account With<span>  Email </span></h2>

                            <p style="color: #000000"><i class="fa fa-whatsapp" style="font-size:45px;color:#ffcc00"></i> Register with Phone<a href="registerPhone.jsp" > Click here</a><p>
                            <p >Login Your Account <a href="login.jsp">Click here</a></p>

                        </div>	
                        <form class="contact-bx" action="registerController" method="POST" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group row" style="margin: 15px 0">
                                            ...
                                            <input name="code" type="text" value="${code}" class="form-control col-md-7">
                                            <input style="margin-top: 5px; margin-left: 20px" class="btn button-md col-md-4" type="submit" name ="op" value ="Send Code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="newPass" value="${newPass}" type="password" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <br>
                                            <input name="reNewPass" value="${reNewPass}" type="password"  class="form-control">
                                        </div>
                                    </div>
                                </div>  
