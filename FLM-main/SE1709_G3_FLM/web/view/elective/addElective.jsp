    ...
    <body id="bg">
        ...
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            ...
                            <li><a href="/SE1709_G3_FLM/view/userAccess/homePage.jsp">Add Elective</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <!--About Us--> 
                <form id="frm" class="content-block" action="ElectiveController" method="post">
                                            ...
                                            <div class="edit-profile" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        ...
                                                        <input name="btn_oke" class="btn" type="submit" value="Add" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
