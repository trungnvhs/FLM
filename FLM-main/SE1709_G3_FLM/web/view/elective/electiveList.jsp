                ...
                <div class="card">
                    ...
                    <div style="padding: 20px">
                        ...
                        <h4 style="border-bottom: 2px solid #8898aa;">
                            <b>Elective Managament</b>
                        </h4>
                        <h5 style="border-bottom: 2px solid #8898aa;">

                            CurriculumID: ${dataCu.getCurriculum_id()}
                            <br> <br>
                            CurriculumCode: ${dataCu.getCode()}
                            <br> <br>
                            CurriculumName: ${dataCu.getName()}

                        </h5>

                        <form action="ElectiveController" method="post">
                            <c:if test="${role=='Staff' || role=='Head'}">
                                <div  style="text-align: right; margin-right: 20px">
                                    <button name="add" type="submit" value="Submit" class="btn button-md">New Elective</button>
                                    <input type="hidden" name="curriculumid" value="${dataCu.getCurriculum_id()}" />
                                    <br><!-- comment -->
                        ...
                        <table class="table no-wrap user-table mb-0" style="height: 500px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th scope="col" class="border-0 text-uppercase font-medium" style="width: 200px">Elective ID</th>
                                    <th scope="col" class="border-0 text-uppercase font-medium" style="width: 350px">Elective Name</th>
                                    <th scope="col" class="border-0 text-uppercase font-medium" style="width: 450px">Subject</th>
                                    <th scope="col" class="border-0 text-uppercase font-medium" style="width: 100px"></th><!-- comment -->
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <c:forEach items="${dataelec}" var="i">
                                    <tr style="text-align: center;tab-size: 20px">
                                        ...
                                        <td class="p-3"><a style="text-decoration: underline;" href="/SE1709_G3_FLM/view/elective/ElectiveDetailController?cu_id=${curID}&&gr_id=${i.getGroup_id()}">${i.getCombo_subject()}--${i.getCurriculum_id()}</a></td>
                                        <c:if test="${role=='Staff' || role=='Head'}">
                                            <td class="col-md-2" style="align-content:center">
                                                <a id="redirect_link"  style="display: none;" href="ElectiveController?gr_id=${i.getGroup_id()}&cu_id=${dataCu.getCurriculum_id()}&mod=delete"></a>
