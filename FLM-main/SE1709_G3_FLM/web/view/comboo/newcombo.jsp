    ...
    <body id="bg" >
        ...
        <div class="page-wraper">
            ...
            <div class="page-content bg-white" >
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            ...
                            <li> <a href="/SE1709_G3_FLM/view/comboo/ComboController?cu_id=${curID}">Combo List</a></li>
                            <li> New Combo Details</li>
                ...
                <!--About Us--> 
                <form id="frm" class="content-block" action="ComboController" method="post">
                                            ...
                                            <div class="edit-profile" >
                                                <div class="">
                                                    <!--                                                    <div class="form-group row">
                                                                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label"> Combo Name <b style="color: red"> (*)</b> </label>
                                                                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-6">
                                                                                                                <input style="width: 600px" id="name" name="name" class="form-control" type="text" value="${name}" >
                                                                                                                <p style="color: red">${error1}</p>
                                                                                                            </div>
                                                                                                        </div>-->
                                                    <div class="form-group row" style="display: none">
                                                        <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label" style="display: none">Type</label>
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-9" >
                                                            <input style="width: 600px" name="type" class="form-control" type="text"  required="" value="Combo" readonly="">
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row" style="display: none">
                                                        <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label" style="display: none">Curriculum</label>
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-6">
                                                    ...
                                                    <div class="form-group row" style="height: 300px">
                                                        <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Combo</label>
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-6">
        ...
        <script>
            ...
            input.addEventListener('input', function () {
                if (this.value.length > 1000) {
                    this.value = this.value.slice(1, 250); // Cắt bớt giá trị nhập vào
                }
            });
        </script>
    </body>
