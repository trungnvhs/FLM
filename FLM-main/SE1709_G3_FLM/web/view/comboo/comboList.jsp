                ...
                <div class="row">
                    <div class="card">
                        <div style="padding: 20px">
                            ...
                            <form action="ComboController" method="post">
                                <c:if test="${role=='Staff' || role=='Head'}">
                                    <div  style="text-align: right; margin-right: 20px">
                                        <button name="add" type="submit" value="Submit" class="btn button-md">New Combo</button>
                                        <br><!-- comment -->
                            ...
                            <table class="table no-wrap user-table mb-0" style="height: 500px">
                                <thead>
                                    <tr style="text-align: center">
                                        ...
                                        <th scope="col" class="border-0 text-uppercase font-medium" style="width: 200px">Combo ID</th>
                                        <th scope="col" class="border-0 text-uppercase font-medium" style="width: 800px">Combo Name</th>
                                        <th scope="col" class="border-0 text-uppercase font-medium" style="width: 200px">Active</th>
                                        <th scope="col" class="border-0 text-uppercase font-medium" style="width: 100px"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <c:forEach items="${dataelec}" var="i">
                                        <tr style="text-align: center;tab-size: 20px">
                                            ...
                                            <td class="p-3"><a style="text-decoration: underline;" href="/SE1709_G3_FLM/view/comboo/ComboDetailController?cu_id=${curID}&gr_id=${i.getGroup_id()}">${i.getCombo_subject()}:${i.getName()}</a></td>
                                            <td class="p-3">
                                                <c:if test="${i.getIs_active()=='1'}">
                                                    True
                                                </c:if>
                                                <c:if test="${i.getIs_active()=='0'}">
                                                    False
                                                </c:if>
                                            </td>
                                            ...
                                            <c:if test="${role=='Staff' || role=='Head'}">
                                                <td class="col-md-2" style="align-content:center">
                                                    ...
                                                    <a id="redirect_link"  style="display: none;" href="ComboController?gr_id=${i.getGroup_id()}&cu_id=${curID}&mod=delete" ></a>
                                                </td>
                                            </c:if>
                                        </tr> 
                                    </c:forEach>
