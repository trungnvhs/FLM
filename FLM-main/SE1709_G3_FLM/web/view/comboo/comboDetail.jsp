                    ...
                    <div class="card">
                        <div style="padding: 20px">
                            ...
                            <h4 style="border-bottom: 2px solid #8898aa;">
                                <b>View Combo Detail</b>
                            </h4>

                            <h5 style="border-bottom: 2px solid #8898aa;">


                                Combo Name: ${elec.getCombo_subject()}:${elec.getName()}
                                <br> <br>
                                Note: 
                            </h5>
                        </div>
                        <h4 style="padding-left: 20px">
                            <b>List Subject Combo</b>
                        </h4>
<!--                        <form action="ComboDetailController" method="post">
                            <c:if test="${role=='Staff' || role=='Head'}">
                                <div  style="text-align: right; margin-right: 20px">
                                    <button name="add1" type="submit" value="Submit" class="btn button-md">New Combo Details</button>
                            ...
                            <table class="table no-wrap user-table mb-0" style="height: 500px">
                                <thead>
                                    <tr style="text-align: center">
                                        ...
                                        <th scope="col" class="border-0 text-uppercase font-medium" style="width: 150px">Semester</th>
                                        ...
                                        <tr style="text-align: center;tab-size: 20px">
                                            ...
                                            <c:if test="${role=='Staff' || role=='Head'}">
                                                <td class="col-md-2" style="align-content:center">
                                                    <a id="redirect_link"  style="display: none;" href="ComboDetailController?subject_id=${i.getGroup_id()}&&gr_id=${groupid}&&mod=delete" ></a>
