                                            ...
                                            <div class="">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <div>${subject.getCode()}</div>
                                                        <!--<input name="code" class="form-control" type="text" value="${code}" required="">-->
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Subject Name</label>
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                                                        <div>${subject.getName()}</div>
                                                        <!--<input name="name" class="form-control" type="text"  required="" value="${name}"></input>-->
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Type</label>
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                                                        <div>${subject.getType()}</div>
                                                        <!--<input name="name" class="form-control" type="text"  required="" value="${name}"></input>-->
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                                                        <div><pre>${subject.getDescription()}</pre></div>
