                ...
                <div class="page-banner ovbl-dark"
                    ...
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Subject Successors</h1>
                        </div>
                    </div>
                </div>
                <!--Breadcrumb row-->
                            ...
                            <div class="row">
                                <div class="card col-md-12">
                                    <div class="card-body" style="margin-left: 30px">
                                        <h4 class="card-title text-uppercase mb-0">Subject Successors
                                        </h4>
                                    </div>
                                    <div style="margin-top: -50px">
                                        <div class="row" style="margin-bottom: 20px">
                                            ...
                                            <div class="search-bx style-1 col-lg-4 col-xl-4 col-md-5">
                                                <form action="subjectsucc" method="post">
                                                ...
                                                <table
                                                    ...
                                                    <thead class="pricingtable-title">
                                                        <tr class="row">
                                                            ...
                                                            <th class="col-md-3">All subjects need to learn after</th>
                                                            <!--<th>Display Order</th>-->
                                                        </tr>
                                                    </thead>
                                                        ...
                                                        <tr class="row">
                                                            ...
                                                            <td class="col-md-3">
                                                                ...
                                                                <div style="text-align: left">
                                                                    <c:forEach var="i" items="${sList}">
                                                                        <span> - </span>${i.getCode()}:
                                                                        <c:if test="${SyllabusDAO.getSuc(i.getCode()).size() == 0}">None<br></c:if>
                                                                        <c:if test="${SyllabusDAO.getSuc(i.getCode()).size() != 0}">
                                                                            <c:forEach var="item" items="${SyllabusDAO.getSuc(i.getCode())}">
                                                                                ${item.getCode()},
                                                                            </c:forEach>
                                                                            <br>
                                                                        </c:if>
