<%-- 
    Document   : mappingClo_Plo.jsp
    Created on : Jul 22, 2023, 8:43:53 AM
    Author     : ThinkPad P50
--%>
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            ...
                            <li><a href="../clo/clolist">CLO List</a></li>
                            <li></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <div class="table-responsive shadow rounded">
                                    <form action="cloplo" method="post">
                                        <table  class="table table-center bg-white mb-0">
                                            <thead>
                                                <tr class="headtable" >
                                                    <td colspan="100%"  class="border-bottom p-9" style="background-color:#396cf0;text-align: center;height:60px; color: #ffffff; background-color: #4c1864">Mapping of CLOs to PLOs of Curriculum BIT_SE</td>
                                                </tr>
                                                <tr>
                                                    <th class="border-bottom p-3" style="text-align: center" >PLO_CLO</th>
                                                        <c:forEach var="plo" items="${ListPlo}">
                                                        <th class="border-bottom p-3" style="min-width: 120px;text-align: center">${plo.name}</th>
                                                        </c:forEach>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <c:forEach var="clo" items="${ListClo}">
                                                    <tr class="ListPLO ">
                                                        <td class="p-3" >${clo.clo_name}</td>
                                                        <c:forEach var="plo" items="${ListPlo}">
                                                            <c:set var="para" value="mapping${clo.clo_id}_${plo.plo_id}" />
                                                        ...
                                                        <!--<li class="d-flex justify-content-center" style="text-align: center; ">-->
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input"  type="checkbox" name="mapping${clo.clo_id}_${plo.plo_id}" value="1" style="height: 25px; width: 25px"
