<%-- 
    Document   : poDetail.jsp
    Created on : Jun 20, 2023, 9:53:30 PM
    Author     : ThinkPad P50
--%>
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-12 m-b30">
                                <div class="profile-content-bx">   
                                    <div class="tab-pane" id="edit-profile">
                                        ...
                                        <form class="edit-profile m-b30" action="poadd" method="post">
                                            <input type="text" name="mod" value="update" style="display: none">
                                            <div class="edit-profile" >
                                                <div class="">
                                                    <input name="poid" value="${po.getPo_id()}" style="display: none">
                                                    <div class="form-group row">
                                                        <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">PO Name : <i style="color: red">*</i></label>
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                                                            <div> <input name="name" class="form-control" type="text" value="${po.getName()}" required="" maxlength="20"></div>
                                                            <input name="namec" value="${po.getName()}" style="display: none">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                                                            <textarea name="description" class="form-control"  style="height: 250px;" required="" maxlength="250">${po.description}</textarea>
                                                        </div>
                                                    </div>   
                                                    <input name="cu_id" value="${po.getCurriculum_id()}" style="display: none">  
                                                    <div class="form-group row">
                                                        <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Is Active : </label>
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            <input name="isact" value="${po.getIs_active()}" style="display: none">
                                                                <c:if test="${po.getIs_active()=='1'}">
