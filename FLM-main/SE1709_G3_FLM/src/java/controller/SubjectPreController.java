 ...
 * @author ThinkPad P50
 */
public class SubjectPreController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getParameter("mod") != null && req.getParameter("mod").equals("search")) {
            ...
            if (text.equals("")) {
                ...
                ArrayList<Pre_requisite> sList = SyllabusDAO.getPre(text);
            ...
            req.getRequestDispatcher("/view/subject/subjectPredecessors.jsp").forward(req, resp);
        }
