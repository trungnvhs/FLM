...
public class RegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!check) {
            if (req.getParameter("op").equals("Send Code")) {
                ...
                req.getRequestDispatcher("/view/userAccess/register.jsp").forward(req, resp);
            }
            ...
            if (req.getParameter("op").equals("Submit")) {
                ...
                if (noncode.equals(code)) {
                    ...
                    req.setAttribute("reNewPass", reNewPass);
                    req.setAttribute("emailContent", noncode);
                    req.setAttribute("error2", "Register Code is wrong*");
                    req.getRequestDispatcher("/view/userAccess/register.jsp").forward(req, resp);
                }
            }
        } else {
            req.setAttribute("error3", "Email exist in system*");
            req.setAttribute("email", email);
            req.getRequestDispatcher("/view/userAccess/register.jsp").forward(req, resp);
...
//                    
//                    if (newPass.equals(reNewPass)) {
//                        UserDAO.addNewUser(newPass, userid,email,avatar);
...
//            }
//        } else {
//            req.setAttribute("error3", "Email exist*");
//            req.getRequestDispatcher("/view/userAccess/register.jsp").forward(req, resp);
//
//        }
//    }
